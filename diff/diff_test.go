...
`,
	...
	t.Run("OnChange", func(t *testing.T) {
		...
		diffOptions := Options{"diff", 10, false, false, "", "", true, []string{}, 0.0}
...
`, buf1.String())
	...
	t.Run("OnChangeRename", func(t *testing.T) {
		var buf1 bytes.Buffer
		diffOptions := Options{"diff", 10, false, false, "", "", true, []string{}, 0.5}
...
`, buf1.String())
	...
	t.Run("OnChangeSimple", func(t *testing.T) {
		var buf1 bytes.Buffer
		diffOptions := Options{"simple", 10, false, false, "", "", true, []string{}, 0.0}
...
`, buf1.String())
	...
	t.Run("OnChangeTemplate", func(t *testing.T) {
		var buf1 bytes.Buffer
		diffOptions := Options{"template", 10, false, false, "", "", true, []string{}, 0.0}
...
`, buf1.String())
	...
	t.Run("OnChangeJSON", func(t *testing.T) {
		var buf1 bytes.Buffer
		diffOptions := Options{"json", 10, false, false, "", "", true, []string{}, 0.0}
